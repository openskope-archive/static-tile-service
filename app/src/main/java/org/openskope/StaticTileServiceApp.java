...
@ComponentScan
public class StaticTileServiceApp {
    ...
    public static ExitCode startServiceForArgs(String [] args, 
        ...
        StaticTileServiceApp.outStream = outStream;
        StaticTileServiceApp.errStream = errStream;

        versionInfo = VersionInfo.loadVersionInfoFromResource(
            "SKOPE Static Tile Service", 
            "https://github.com/openskope/static-tile-service.git",
            "git.properties",
            "maven.properties");        
        ...
        SpringApplication.run(StaticTileServiceApp.class, args);
...
//            printToolUsageErrors(e.getMessage());
    ...
    private static OptionParser createOptionsParser() throws Exception {
        ...
        OptionParser parser = new OptionParser() {{
            ...
            acceptsAll(Arrays.asList("server.port"), "Sets static tile service port.");
            acceptsAll(Arrays.asList("static-tile-service.url"), "Sets URL of service providing map tiles for display.");
            acceptsAll(Arrays.asList("static-tile-service.tiles-dir"),"Sets path to directory containing map tile directory trees.");
        }};
